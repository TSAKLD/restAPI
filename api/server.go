...
func (s *Server) setRoutes() {
	...
	s.router.HandleFunc("POST /projects", s.h.DeleteProject)
	s.router.HandleFunc("GET /projects/{owner_id}", s.h.Projects)
	s.router.HandleFunc("POST /projects", s.h.ProjectByID)
